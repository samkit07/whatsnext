 ...
 * Use the [fragment2_5.newInstance] factory method to
...
class fragment2_5 : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View = inflater.inflate(R.layout.fragment2_5, container, false)
        ...
        for(i in 0 until courses.data[4].degree.size) {
            degreeMap[courses.data[4].degree[i]] = courses.data[4].degree[i].fields
        }
        listviewAd = ExListAdapter2(context as page2Activity, courses.data[4].degree, degreeMap)
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment2_5.
         */
