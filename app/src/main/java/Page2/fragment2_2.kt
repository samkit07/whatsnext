 ...
 * Use the [fragment2_2.newInstance] factory method to
...
class fragment2_2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View = inflater.inflate(R.layout.fragment2_2, container, false)
        ...
        listviewAd = ExListAdapter2(context as page2Activity, courses.data[1].degree, degreeMap)
        expandView = view.findViewById(R.id.expandlist2_2)
        expandView.setAdapter(listviewAd)
//        view.findViewById<TextView>(R.id.tv_eligible).text = "Elligibility: "+courses.data[1].eligibility
