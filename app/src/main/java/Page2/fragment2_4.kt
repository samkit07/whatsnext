 ...
 * Use the [fragment2_4.newInstance] factory method to
...
class fragment2_4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View = inflater.inflate(R.layout.fragment2_4, container, false)
        ...
        for(i in 0 until courses.data[3].degree.size) {
            degreeMap[courses.data[3].degree[i]] = courses.data[3].degree[i].fields
        }
        listviewAd = ExListAdapter2(context as page2Activity, courses.data[3].degree, degreeMap)
        expandView = view.findViewById(R.id.expandlist2_4)
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment2_4.
         */
